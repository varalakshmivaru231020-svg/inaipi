...
export default function Hero() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-[100vh] pt-32 pb-0 flex flex-col items-center overflow-visible" style={{ background: 'linear-gradient(160deg, #eef4ff 0%, #fafbff 40%, #e8f4ff 100%)' }}>
        ...
        <div className="flex items-start justify-center gap-0" style={{ minHeight: '640px' }}>
          ...
          <div className="flex flex-col gap-3 w-60 shrink-0 self-center z-20 -mr-5">
            ...
            <motion.div
              ...
              style={{ height: '280px', background: 'linear-gradient(160deg, #ffffff 0%, #f0f5ff 100%)', boxShadow: '0 20px 60px -10px rgba(37,99,235,0.20), 0 4px 20px -2px rgba(0,111,255,0.10)' }}
            >
              <div className="flex items-center gap-2 px-3 py-2 border-b border-blue-100/60 shrink-0">
                <motion.div animate={{ scale: [1, 1.1, 1] }} transition={{ duration: 2, repeat: Infinity }}
                  className="w-5 h-5 rounded-lg bg-gradient-to-br from-[#1447d4] to-[#006fff] flex items-center justify-center shrink-0 overflow-hidden">
          ...
          >
            {/* Center top bar */}
            <div className="flex items-center px-5 py-3 shrink-0" style={{ background: 'linear-gradient(135deg, #1447d4 0%, #006fff 60%, #00e7ff 100%)' }}>
            ...
            <div className="px-5 pt-3.5 pb-3 border-b border-slate-100 shrink-0">
              ...
              <div className="grid grid-cols-5 gap-2">
                {[
                  ...
                  { label: 'Interactions',  value: (48247 + resolvedCount).toLocaleString(),    bg: 'bg-blue-50',   border: 'border-blue-100',   text: 'text-blue-700'  },
                  { label: 'Queue',         value: '0',                                         bg: 'bg-green-50',  border: 'border-green-100',  text: 'text-green-700' },
                  { label: 'Satisfaction',  value: `${csatScore.toFixed(1)}/5.0`,               bg: 'bg-cyan-50',   border: 'border-cyan-100',   text: 'text-cyan-700'  },
            ...
            <div className="flex-1 p-3 grid grid-cols-2 gap-2 content-start overflow-hidden">
              {AGENTS.map((agent, i) => {
                const palette = [
                  ...
                  { bg: 'bg-blue-50',   border: 'border-blue-100',   activeBorder: 'rgba(0,111,255,0.55)'  },
                  { bg: 'bg-green-50',  border: 'border-green-100',  activeBorder: 'rgba(34,197,94,0.55)'  },
                  { bg: 'bg-cyan-50',   border: 'border-cyan-100',   activeBorder: 'rgba(0,231,255,0.55)'  },
              ...
              <div className="max-w-[480px] mx-auto rounded-2xl border border-blue-100 overflow-hidden shadow-sm" style={{ background: 'linear-gradient(135deg, #f0f7ff 0%, #ffffff 100%)' }}>
                ...
                <div className="grid grid-cols-3 divide-x divide-blue-50 py-2.5">
                  {[
                    ...
                    { icon: Zap,   label: 'Avg Handle',   value: '1m 24s',                         color: 'text-[#1447d4]' },
                    { icon: Star,  label: 'AI CSAT',      value: `${csatScore.toFixed(1)}★`,        color: 'text-[#006fff]' },
                  ].map((item, i) => (
          ...
          <div className="flex flex-col gap-3 shrink-0 -mt-8 -ml-5 w-72 z-20">
            ...
            <motion.div
              ...
              style={{ background: 'linear-gradient(135deg, #ffffff 0%, #eff6ff 50%, #eef6ff 100%)', boxShadow: '0 12px 40px -8px rgba(37,99,235,0.18), 0 2px 12px -2px rgba(0,111,255,0.10)' }}
            >
              {/* Header */}
              <div className="flex items-center gap-2 px-3 py-2 border-b border-blue-100/60" style={{ background: 'linear-gradient(90deg, #dbeafe 0%, #e0f2fe 100%)' }}>
            ...
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.45, ease: [0.22, 1, 0.36, 1] }}
              className="rounded-2xl border border-blue-100/80 overflow-hidden flex-1"
              style={{ background: 'linear-gradient(135deg, #ffffff 0%, #f0f8ff 50%, #e8f4ff 100%)', boxShadow: '0 12px 40px -8px rgba(0,231,255,0.15), 0 2px 12px -2px rgba(0,111,255,0.10)' }}
            >
              {/* Header */}
              <div className="flex items-center gap-2 px-3 py-2.5 border-b border-blue-100/60" style={{ background: 'linear-gradient(90deg, #dbeafe 0%, #e0f2fe 100%)' }}>
                <Star className="w-3 h-3 text-[#006fff]" />
                <span className="text-[9px] font-black uppercase tracking-widest text-[#1447d4]">Customer Satisfaction</span>
              </div>
              <div className="px-3 py-2.5 flex flex-col gap-2">
                    ...
                    <svg viewBox="0 0 36 36" className="w-full h-full -rotate-90">
                      ...
                      <defs>
                        <linearGradient id="csatGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                          ...
                          <stop offset="100%" stopColor="#1447d4" />
                        </linearGradient>
                      </defs>
                    </svg>
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-[10px] font-black text-[#006fff]">90%</span>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-1.5">
                  {[
                    { label: 'NPS',       value: '72',  color: 'text-[#006fff]',  bg: 'from-cyan-50 to-blue-50'   },
                ...
                <div className="flex flex-col gap-1">
                  {RECENT_REVIEWS.map((r, i) => (
                    <div key={i} className="flex items-center gap-1.5 px-1.5 py-1 rounded-lg bg-white/60">
                      <div className="w-4 h-4 rounded-full flex items-center justify-center shrink-0 overflow-hidden" style={{ background: 'linear-gradient(135deg, #dbeafe, #e0f2fe)' }}>
